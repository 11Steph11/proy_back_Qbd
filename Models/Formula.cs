...
namespace Proy_back_QBD.Models
{
    ...
    public class Formula
    {
        ...
        [Column("creador")]
        public int Creador { get; set; }                      // ID del usuario que creó el registro

        [Column("modificador")]
        public int Modificador { get; set; }                  // ID del último usuario que modificó el registro

        [Column("fecha_entrega")]
        public DateTime FechaEntrega { get; set; } 
        public Pedido? Pedido { get; set; } 
        [Column("pedido_id")]
        public int PedidoId { get; set; }                     // ID del pedido (referencia a otro registro si es necesario)
    }
